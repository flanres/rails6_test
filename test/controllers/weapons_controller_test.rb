...
class WeaponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weapon" do
    assert_difference('Weapon.count') do
      post weapons_url, params: { weapon: { attack: @weapon.attack, name: @weapon.name, rate: @weapon.rate } }
    end
  ...
  test "should update weapon" do
    patch weapon_url(@weapon), params: { weapon: { attack: @weapon.attack, name: @weapon.name, rate: @weapon.rate } }
